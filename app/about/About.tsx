  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Code to Destiny?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Code to Destiny, the premier programming community
          dedicated to helping new programmers achieve their goals and reach
          their full potential.
          <br />
          <br />
          As the founder and CEO of Code to Destiny, I know firsthand the
          challenges that come with learning and growing in the programming
          industry. That&apos;s why I created Code to Destiny &ndash; to provide
          new programmers with the resources and support they need to succeed.
          <br />
          <br />
          ...
          <br />
          <br />
          At Code to Destiny, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Code to Destiny is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Code to Destiny by your side, there&apos;s nothing standing
          between you and your dream job. Our courses and community will provide
          you with the guidance, support, and motivation you need to unleash
          your full potential and become a skilled programmer.
          <br />
          <br />
          So what are you waiting for? Join the Code to Destiny family today and
        ...
        <br />
        <span className="text-[22px]">Thomas Okram</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Code to Destiny
        </h5>
        <br />
        <br />
        <br />
