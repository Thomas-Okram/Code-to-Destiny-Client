...
const AllVideos = (props: Props) => {
  ...
  const { isLoading, data, refetch } = useGetAllVideosQuery(
    {},
    { refetchOnMountOrArgChange: true }
  );
  const [deleteVideo, { isSuccess, error }] = useDeleteVideoMutation({});
